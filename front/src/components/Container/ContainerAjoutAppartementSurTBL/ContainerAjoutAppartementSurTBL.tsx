...
import '../ContainerAjoutAppartementSurTBL/ContainerAjoutAppartementSurTBL.css'
import { createAppartement } from '../../../services/appartements_api'

const ContainerAjoutAppartementSurTBL = () => {
...
export default ContainerAjoutAppartementSurTBL